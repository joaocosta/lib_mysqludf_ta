...
fpm -t rpm -d "mysql-server >= 5.1" --description "Trading technical analysis functions as MySQL UDFs" --url https://github.com/joaocosta/lib_mysqludf_ta/ -m "joaocosta@zonalivre.org" -s dir -n libmysqludf_ta -v 0.1 --iteration $RELEASE -C $INSTALLDIR usr
