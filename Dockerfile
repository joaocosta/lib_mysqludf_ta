...
# docker run --name fxdata -v $HOME/mysql:/var/lib/mysql -v $HOME/fxtrader.cfg/mariadb:/etc/mysql/conf.d --hostname=datatest -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=fxdata -d --name fxdatatest lib_mysqludf/tatest
