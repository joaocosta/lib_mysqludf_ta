...
my_bool ta_min_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
{
	ta_min_data* data;
...
void ta_min_deinit(UDF_INIT *initid)
{
	free(initid->ptr);
}

double ta_min(UDF_INIT *initid, UDF_ARGS *args, char *is_null, char *error)
{
